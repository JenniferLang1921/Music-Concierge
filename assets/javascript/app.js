...
function displayArtistInfo(data, location) {
    ...
    var newEventWidget = $('<div class="card mb-4 bg-primary text-white"><div class="card-body"><script charset="utf-8" src="https://widget.bandsintown.com/main.min.js"></script><a class="card-text bit-widget-initializer" data-artist-name="' + itemArtist + '" data-display-local-dates="false" data-display-past-dates="true" data-auto-style="false" data-text-color="#000000" data-link-color="#E74832" data-popup-background-color="rgba(0,0,0,0)" data-background-color="rgba(0,0,0,0)" data-display-limit="15" data-link-text-color="#000000"></a><h5 </div>');

    var newCard = $('<div class="row"><div class="card dummy-media-object artist-result"><h5 class="card-header mt-0 mb-1 bg-transparent">' + itemArtist + '</h5><div class="card-body"><li class="media"><img class="img-thumbnail mr-3" src="' + itemImage + '" alt="Generic placeholder image"><div class="media-body"><p class="text-left">' + itemBio + '</p></div></li></div><div class="card-footer bg-transparent"><div id="artist-video' + counter + '">*</div><hr><div class="card text-center my-3 border-0 bg-transparent"><div class="mb-2" id="accordion' + counter + '"><button class="btn btn-link p-0 text-danger" data-toggle="collapse" data-target="#collapse' + counter + '" aria-expanded="true" aria-controls="collapse' + counter + '">Click Here for Tour Dates</button></div></div><div id="collapse' + counter + '" class="collapse" aria-labelledby="headingOne" data-parent="#accordion' + counter + '"><div class="card-body" id="collapse-widget">' + newEventWidget["0"].innerHTML + '</div></div></div></div></div>');
